...
export const LabelPicker = ({ selectedLabels, onLabelSelected }: LabelPickerProps) => {
    ...
    <>
      {
        data?.map(label => (
          <span
            key={label.id}
            className={
              `badge rounded-pill m-1 label-picker ${selectedLabels.includes(label.name) && 'label-active'}`
            }
